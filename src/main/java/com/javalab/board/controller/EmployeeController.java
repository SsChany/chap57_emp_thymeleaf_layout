...
public class EmployeeController {
	...
	// 사원 등록 폼
	   ...
	   public String register(Employees emp, Model model){
	      ...
	      // job 정보 조회
	      List<Jobs> jobList = employeeService.getJobList();
	      model.addAttribute("jobList", jobList);      
	      return "form";    // 사원 등록 폼 화면으로 이동
	   }	
	...
	// 사원 수정 폼
	@GetMapping("/edit")
	public String edit(@RequestParam("employeeId") int employeeIdid, Model model){
	...
	public String edit(Employees emp){
		...
		// 게시물 등록(저장)
		int result = employeeService.edit(emp);
